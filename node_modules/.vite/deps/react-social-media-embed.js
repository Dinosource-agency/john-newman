import {
  ...
  init_compat_module
} from "./chunk-5YXUTYUA.js";
import "./chunk-MFBCTHDW.js";
import "./chunk-5GFP4GZU.js";
import {
  __commonJS,
  __esm,
  __export,
...
var require_useFrame = __commonJS({
  "node_modules/react-social-media-embed/dist/components/hooks/useFrame.js"(exports) {
    ...
    var react_1 = __importDefault((init_compat_module(), __toCommonJS(compat_module_exports)));
    var useFrame = (frame) => {
...
var init_index_modern = __esm({
  "node_modules/react-twitter-embed/dist/index.modern.js"() {
    ...
    TwitterTimelineEmbed = function TwitterTimelineEmbed2(props) {
      var ref = Cn.useRef(null);
      var _React$useState = Cn.useState(true), loading = _React$useState[0], setLoading = _React$useState[1];
      ...
      return Cn.createElement(Cn.Fragment, null, loading && Cn.createElement(Cn.Fragment, null, props.placeholder), Cn.createElement("div", {
        ref
      }));
    };
  ...
  "node_modules/react-social-media-embed/dist/components/embeds/TwitterEmbed.js"(exports) {
    ...
    var TwitterEmbed = (_a) => {
      ...
      return React.createElement(
        ...
        React.createElement(EmbedStyle_1.EmbedStyle, null),
        React.createElement(react_twitter_embed_1.TwitterTweetEmbed, Object.assign({ tweetId, placeholder: placeholderDisabled ? void 0 : placeholder }, twitterTweetEmbedProps))
      );
    };
...
var import_prop_types, import_fast_deep_equal, import_youtube_player, __defProp, __defProps, __getOwnPropDescs, __getOwnPropSymbols, __hasOwnProp, __propIsEnum, __defNormalProp, __spreadValues, __spreadProps, __async, defaultProps, propTypes, _YouTube, YouTube, YouTube_default;
var init_YouTube_esm = __esm({
  "node_modules/react-youtube/dist/YouTube.esm.js"() {
    ...
    _YouTube = class extends Cn.Component {
      constructor(props) {
        super(props);
