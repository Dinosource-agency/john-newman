import { c as Xe, g as qe } from './index-2e1151fe.js';
function Ue(G, Q) {
 ...
 */ (function (G, Q) {
	(function (y) {
		...
		var De = function () {
			try {
				return (
					new J().decode(new ve().encode('test'), { stream: !0 }) ===
					'test'
				);
			} catch (e) {
				console.debug(
...
`),
		...
		var be = K;
		h != null &&
			(K == null || !('withCredentials' in K.prototype)) &&
			(be = A),
			(function (e) {
				{
					var r = e(Q);
